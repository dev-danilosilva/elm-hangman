...
var $author$project$Main$wordEndpoint = 'http://127.0.0.1:5000/api/word';
var $author$project$Main$requestWord = $elm$http$Http$get(
	{
			...
			case 'NewGuess':
				...
				if (model.$ === 'Success') {
					...
					var wordGuessIntersect = function (_v2) {
						var res = _v2.a;
						var newState = _v2.b;
						return res ? $author$project$Main$Victory(newState) : $author$project$Main$Success(newState);
					}(
...
var $author$project$Main$view = function (model) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$NewGuess(_char))
						]),
					_List_fromArray(
						[
	...
	var asList = $elm$core$String$split('');
	var asSet = function (str) {
		return $elm$core$Set$fromList(
			asList(str));
	};
	var attemptsElement = function (state) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('past-attempts')
				]),
			A2(
				$elm$core$List$map,
				function (attempt) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('past-attempt')
							]),
						_List_fromArray(
							[
				...
				A2(
					...
					$elm$core$Set$toList(state.pastGuesses))));
	};
	var wordElement = function (state) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('phraseContainer')
				]),
			A2(
				$elm$core$List$map,
				function (_char) {
				...
				A2(
					...
					function (_char) {
						if (_char === ' ') {
							...
							return A2($elm$core$Set$member, _char, state.pastGuesses) ? _char : '_';
						}
					},
					asList(state.word))));
	};
	switch (model.$) {
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('loading-page')
					]),
				_List_fromArray(
					[
						A2(
		...
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('error-page')
					]),
				_List_fromArray(
					[
						A2(
		...
		case 'Victory':
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('victory-page')
					]),
				_List_fromArray(
					[
						A2(
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('defeat-page')
					]),
				_List_fromArray(
					[
						A2(
